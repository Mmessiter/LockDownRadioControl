...
{ 
    ...
    if ((!BuddyPupilOnWireless) || (BuddyHasAllSwitches)) { // if BuddyPupilOnWireless is not using switches
        ReadSafetySwitch(); 
        ReadBuddySwitch();
        ReadDualRateSwitch();
        ReadBankSwitch();
...
void CheckPowerOffButton()
{
    ...
    { // power button is pressed!
        ...
        if (BoundFlag && ModelMatched && CurrentView != FRONTVIEW) GotoFrontView();
