...
#define TXVERSION_EXTRA "B 02/03/25" // Improved reliability and code quality
...
uint32_t LastQualityWarningTime = 0;        // Time of last warning message
bool SignalQualityWarningActive = false;    // Whether warning is currently active
uint16_t ConnectionQualityPercent = 100;    // Current connection quality percentage
uint32_t LastSignalQualityRefresh = 0;      // Time of last forced refresh
...
#define BUDDYMSG 22
#define MASTERMSG 23
#define WEAKMSG 24 // "Weak Signal" sound
...
#define WINDOWS1 76
#define WINDOWS2 77
#define CONNECTION_CRITICAL 78
#define CONNECTION_WARNING 79
#define CONNECTION_GOOD 80
...
void ForceSignalQualityUpdateIfNeeded();
