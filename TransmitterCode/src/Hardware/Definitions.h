...
#define TXVERSION_MINIMUS 6 //   September 2023
...
#define RETRYCOUNT               7  // 2  // auto retries inside nRF24L01. MAX is 15. Fails below 2.
#define RETRYWAIT                1  // = 250us = Wait between retries (RetryWait+1 * 250us)
